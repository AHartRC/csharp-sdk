...
namespace Intrinio.SDK.Model.ApiResponse
{
	...
	/// </summary>
	[DataContract]
	public class ApiResponseSecurityEaseOfMovement : IEquatable<ApiResponseSecurityEaseOfMovement>, IValidatableObject
	{
		/// <summary>
		...
		///     available..
		/// </param>
		public ApiResponseSecurityEaseOfMovement(List<EaseOfMovementTechnicalValue> Technicals = default,
		...
		public List<EaseOfMovementTechnicalValue> Technicals { get; set; }
		...
		/// <summary>
		///     Returns true if ApiResponseSecurityEaseOfMovement instances are equal
		/// </summary>
		/// <param name="input">Instance of ApiResponseSecurityEaseOfMovement to be compared</param>
		/// <returns>Boolean</returns>
		public bool Equals(ApiResponseSecurityEaseOfMovement input)
		{
			if (input == null)
				return false;
		...
		{
			return Equals(input as ApiResponseSecurityEaseOfMovement);
		}
