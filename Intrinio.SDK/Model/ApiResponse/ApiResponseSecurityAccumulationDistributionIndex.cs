...
namespace Intrinio.SDK.Model.ApiResponse
{
	...
	[DataContract]
	public class
		ApiResponseSecurityAccumulationDistributionIndex : IEquatable<ApiResponseSecurityAccumulationDistributionIndex>,
			IValidatableObject
	{
		/// <summary>
		...
		///     available..
		/// </param>
		public ApiResponseSecurityAccumulationDistributionIndex(
			List<AccumulationDistributionIndexTechnicalValue> Technicals = default,
			TechnicalIndicator Indicator = default, SecuritySummary Security = default, string NextPage = default)
		{
		...
		public List<AccumulationDistributionIndexTechnicalValue> Technicals { get; set; }
		...
		/// <summary>
		///     Returns true if ApiResponseSecurityAccumulationDistributionIndex instances are equal
		/// </summary>
		/// <param name="input">Instance of ApiResponseSecurityAccumulationDistributionIndex to be compared</param>
		/// <returns>Boolean</returns>
		public bool Equals(ApiResponseSecurityAccumulationDistributionIndex input)
		{
			if (input == null)
				return false;
		...
		public override string ToString()
		{
			...
			sb.Append("class ApiResponseSecurityAccumulationDistributionIndex {\n");
		...
		{
			return Equals(input as ApiResponseSecurityAccumulationDistributionIndex);
		}
