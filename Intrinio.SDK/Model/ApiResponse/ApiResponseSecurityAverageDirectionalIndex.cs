...
using Intrinio.SDK.Model.TechnicalValue;
...
namespace Intrinio.SDK.Model.ApiResponse
{
	...
	/// </summary>
	[DataContract]
	public class ApiResponseSecurityAverageDirectionalIndex : IEquatable<ApiResponseSecurityAverageDirectionalIndex>,
		IValidatableObject
	{
		/// <summary>
		///     Initializes a new instance of the <see cref="ApiResponseSecurityAverageDirectionalIndex" /> class.
		/// </summary>
		...
		///     available..
		/// </param>
		public ApiResponseSecurityAverageDirectionalIndex(
			List<AverageDirectionalIndexTechnicalValue> Technicals = default, TechnicalIndicator Indicator = default,
			SecuritySummary Security = default, string NextPage = default)
		{
		...
		public List<AverageDirectionalIndexTechnicalValue> Technicals { get; set; }
		...
		/// <summary>
		///     Returns true if ApiResponseSecurityAverageDirectionalIndex instances are equal
		/// </summary>
		/// <param name="input">Instance of ApiResponseSecurityAverageDirectionalIndex to be compared</param>
		/// <returns>Boolean</returns>
		public bool Equals(ApiResponseSecurityAverageDirectionalIndex input)
		{
			if (input == null)
				return false;
		...
		public override string ToString()
		{
			...
			sb.Append("class ApiResponseSecurityAverageDirectionalIndex {\n");
		...
		{
			return Equals(input as ApiResponseSecurityAverageDirectionalIndex);
		}
