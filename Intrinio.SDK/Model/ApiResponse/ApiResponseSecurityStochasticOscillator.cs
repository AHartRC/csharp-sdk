...
namespace Intrinio.SDK.Model.ApiResponse
{
	...
	/// </summary>
	[DataContract]
	public class ApiResponseSecurityStochasticOscillator : IEquatable<ApiResponseSecurityStochasticOscillator>,
		IValidatableObject
	{
		/// <summary>
		...
		///     available..
		/// </param>
		public ApiResponseSecurityStochasticOscillator(List<StochasticOscillatorTechnicalValue> Technicals = default,
		...
		{
			return Equals(input as ApiResponseSecurityStochasticOscillator);
		}
