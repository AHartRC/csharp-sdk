...
namespace Intrinio.SDK.Model.ApiResponse
{
	...
	[DataContract]
	public class
		ApiResponseSecurityVolumeWeightedAveragePrice : IEquatable<ApiResponseSecurityVolumeWeightedAveragePrice>,
			IValidatableObject
	{
		/// <summary>
		...
		///     available..
		/// </param>
		public ApiResponseSecurityVolumeWeightedAveragePrice(List<VolumeWeightedAveragePriceValue> Technicals = default,
		...
		public List<VolumeWeightedAveragePriceValue> Technicals { get; set; }
		...
		/// <summary>
		///     Returns true if ApiResponseSecurityVolumeWeightedAveragePrice instances are equal
		/// </summary>
		/// <param name="input">Instance of ApiResponseSecurityVolumeWeightedAveragePrice to be compared</param>
		/// <returns>Boolean</returns>
		public bool Equals(ApiResponseSecurityVolumeWeightedAveragePrice input)
		{
			if (input == null)
				return false;
		...
		{
			return Equals(input as ApiResponseSecurityVolumeWeightedAveragePrice);
		}
