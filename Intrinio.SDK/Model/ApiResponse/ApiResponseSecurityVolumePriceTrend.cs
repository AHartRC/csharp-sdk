...
namespace Intrinio.SDK.Model.ApiResponse
{
	...
	/// </summary>
	[DataContract]
	public class ApiResponseSecurityVolumePriceTrend : IEquatable<ApiResponseSecurityVolumePriceTrend>,
		IValidatableObject
	{
		/// <summary>
		...
		///     available..
		/// </param>
		public ApiResponseSecurityVolumePriceTrend(List<VolumePriceTrendTechnicalValue> Technicals = default,
		...
		/// <summary>
		///     Returns true if ApiResponseSecurityVolumePriceTrend instances are equal
		/// </summary>
		/// <param name="input">Instance of ApiResponseSecurityVolumePriceTrend to be compared</param>
		/// <returns>Boolean</returns>
		public bool Equals(ApiResponseSecurityVolumePriceTrend input)
		{
			if (input == null)
				return false;
