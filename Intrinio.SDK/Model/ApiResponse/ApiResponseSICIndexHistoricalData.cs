...
namespace Intrinio.SDK.Model.ApiResponse
{
	...
	/// </summary>
	[DataContract]
	public class ApiResponseSICIndexHistoricalData : IEquatable<ApiResponseSICIndexHistoricalData>, IValidatableObject
	{
		/// <summary>
		...
		///     available..
		/// </param>
		public ApiResponseSICIndexHistoricalData(List<HistoricalData> HistoricalData = default,
			SICIndex Index = default, string NextPage = default)
		{
