...
namespace Intrinio.SDK.Model.ApiResponse
{
	...
	/// </summary>
	[DataContract]
	public class ApiResponseSecurityIchimokuKinkoHyo : IEquatable<ApiResponseSecurityIchimokuKinkoHyo>,
		IValidatableObject
	{
		/// <summary>
		...
		///     available..
		/// </param>
		public ApiResponseSecurityIchimokuKinkoHyo(List<IchimokuKinkoHyoTechnicalValue> Technicals = default,
		...
		public List<IchimokuKinkoHyoTechnicalValue> Technicals { get; set; }
		...
		/// <summary>
		///     Returns true if ApiResponseSecurityIchimokuKinkoHyo instances are equal
		/// </summary>
		/// <param name="input">Instance of ApiResponseSecurityIchimokuKinkoHyo to be compared</param>
		/// <returns>Boolean</returns>
		public bool Equals(ApiResponseSecurityIchimokuKinkoHyo input)
		{
			if (input == null)
				return false;
		...
		{
			return Equals(input as ApiResponseSecurityIchimokuKinkoHyo);
		}
