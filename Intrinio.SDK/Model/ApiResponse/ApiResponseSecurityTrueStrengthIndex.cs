...
namespace Intrinio.SDK.Model.ApiResponse
{
	...
	/// </summary>
	[DataContract]
	public class ApiResponseSecurityTrueStrengthIndex : IEquatable<ApiResponseSecurityTrueStrengthIndex>,
		IValidatableObject
	{
		/// <summary>
		///     Initializes a new instance of the <see cref="ApiResponseSecurityTrueStrengthIndex" /> class.
		/// </summary>
		...
		///     available..
		/// </param>
		public ApiResponseSecurityTrueStrengthIndex(List<TrueStrengthIndexTechnicalValue> Technicals = default,
		...
		public List<TrueStrengthIndexTechnicalValue> Technicals { get; set; }
		...
		/// <summary>
		///     Returns true if ApiResponseSecurityTrueStrengthIndex instances are equal
		/// </summary>
		/// <param name="input">Instance of ApiResponseSecurityTrueStrengthIndex to be compared</param>
		/// <returns>Boolean</returns>
		public bool Equals(ApiResponseSecurityTrueStrengthIndex input)
		{
			if (input == null)
				return false;
		...
		{
			return Equals(input as ApiResponseSecurityTrueStrengthIndex);
		}
