...
namespace Intrinio.SDK.Model.ApiResponse
{
	...
	/// </summary>
	[DataContract]
	public class ApiResponseStockMarketIndices : IEquatable<ApiResponseStockMarketIndices>, IValidatableObject
	{
		/// <summary>
		...
		{
			return Equals(input as ApiResponseStockMarketIndices);
		}
