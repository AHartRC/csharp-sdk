...
namespace Intrinio.SDK.Model.ApiResponse
{
	...
	/// </summary>
	[DataContract]
	public class ApiResponseSecurityOnBalanceVolumeMean : IEquatable<ApiResponseSecurityOnBalanceVolumeMean>,
		IValidatableObject
	{
		/// <summary>
		...
		///     available..
		/// </param>
		public ApiResponseSecurityOnBalanceVolumeMean(List<OnBalanceVolumeMeanTechnicalValue> Technicals = default,
		...
		{
			return Equals(input as ApiResponseSecurityOnBalanceVolumeMean);
		}
