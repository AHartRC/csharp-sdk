...
namespace Intrinio.SDK.Model.ApiResponse
{
	...
	/// </summary>
	[DataContract]
	public class ApiResponseSecurityUltimateOscillator : IEquatable<ApiResponseSecurityUltimateOscillator>,
		IValidatableObject
	{
		/// <summary>
		///     Initializes a new instance of the <see cref="ApiResponseSecurityUltimateOscillator" /> class.
		/// </summary>
		...
		///     available..
		/// </param>
		public ApiResponseSecurityUltimateOscillator(List<UltimateOscillatorTechnicalValue> Technicals = default,
		...
		public List<UltimateOscillatorTechnicalValue> Technicals { get; set; }
		...
		/// <summary>
		///     Returns true if ApiResponseSecurityUltimateOscillator instances are equal
		/// </summary>
		/// <param name="input">Instance of ApiResponseSecurityUltimateOscillator to be compared</param>
		/// <returns>Boolean</returns>
		public bool Equals(ApiResponseSecurityUltimateOscillator input)
		{
			if (input == null)
				return false;
		...
		public override string ToString()
		{
			...
			sb.Append("class ApiResponseSecurityUltimateOscillator {\n");
		...
		{
			return Equals(input as ApiResponseSecurityUltimateOscillator);
		}
