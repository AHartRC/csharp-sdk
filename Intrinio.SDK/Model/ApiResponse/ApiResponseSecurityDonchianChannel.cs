...
namespace Intrinio.SDK.Model.ApiResponse
{
	...
	/// </summary>
	[DataContract]
	public class ApiResponseSecurityDonchianChannel : IEquatable<ApiResponseSecurityDonchianChannel>, IValidatableObject
	{
		/// <summary>
		...
		///     available..
		/// </param>
		public ApiResponseSecurityDonchianChannel(List<DonchianChannelTechnicalValue> Technicals = default,
		...
		public List<DonchianChannelTechnicalValue> Technicals { get; set; }
		...
		/// <summary>
		///     Returns true if ApiResponseSecurityDonchianChannel instances are equal
		/// </summary>
		/// <param name="input">Instance of ApiResponseSecurityDonchianChannel to be compared</param>
		/// <returns>Boolean</returns>
		public bool Equals(ApiResponseSecurityDonchianChannel input)
		{
			if (input == null)
				return false;
		...
		{
			return Equals(input as ApiResponseSecurityDonchianChannel);
		}
