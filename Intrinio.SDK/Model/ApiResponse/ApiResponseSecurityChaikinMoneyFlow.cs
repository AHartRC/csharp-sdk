...
namespace Intrinio.SDK.Model.ApiResponse
{
	...
	/// </summary>
	[DataContract]
	public class ApiResponseSecurityChaikinMoneyFlow : IEquatable<ApiResponseSecurityChaikinMoneyFlow>,
		IValidatableObject
	{
		/// <summary>
		...
		///     available..
		/// </param>
		public ApiResponseSecurityChaikinMoneyFlow(List<ChaikinMoneyFlowTechnicalValue> Technicals = default,
		...
		public List<ChaikinMoneyFlowTechnicalValue> Technicals { get; set; }
		...
		/// <summary>
		///     Returns true if ApiResponseSecurityChaikinMoneyFlow instances are equal
		/// </summary>
		/// <param name="input">Instance of ApiResponseSecurityChaikinMoneyFlow to be compared</param>
		/// <returns>Boolean</returns>
		public bool Equals(ApiResponseSecurityChaikinMoneyFlow input)
		{
			if (input == null)
				return false;
		...
		{
			return Equals(input as ApiResponseSecurityChaikinMoneyFlow);
		}
