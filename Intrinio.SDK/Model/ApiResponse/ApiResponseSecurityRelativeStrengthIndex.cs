...
namespace Intrinio.SDK.Model.ApiResponse
{
	...
	/// </summary>
	[DataContract]
	public class ApiResponseSecurityRelativeStrengthIndex : IEquatable<ApiResponseSecurityRelativeStrengthIndex>,
		IValidatableObject
	{
		/// <summary>
		...
		///     available..
		/// </param>
		public ApiResponseSecurityRelativeStrengthIndex(List<RelativeStrengthIndexTechnicalValue> Technicals = default,
		...
		public List<RelativeStrengthIndexTechnicalValue> Technicals { get; set; }
		...
		/// <summary>
		///     Returns true if ApiResponseSecurityRelativeStrengthIndex instances are equal
		/// </summary>
		/// <param name="input">Instance of ApiResponseSecurityRelativeStrengthIndex to be compared</param>
		/// <returns>Boolean</returns>
		public bool Equals(ApiResponseSecurityRelativeStrengthIndex input)
		{
			if (input == null)
				return false;
		...
		{
			return Equals(input as ApiResponseSecurityRelativeStrengthIndex);
		}
