...
namespace Intrinio.SDK.Model.ApiResponse
{
	...
	/// </summary>
	[DataContract]
	public class ApiResponseSecurityKeltnerChannel : IEquatable<ApiResponseSecurityKeltnerChannel>, IValidatableObject
	{
		/// <summary>
		///     Initializes a new instance of the <see cref="ApiResponseSecurityKeltnerChannel" /> class.
		/// </summary>
		...
		///     available..
		/// </param>
		public ApiResponseSecurityKeltnerChannel(List<KeltnerChannelTechnicalValue> Technicals = default,
		...
		public List<KeltnerChannelTechnicalValue> Technicals { get; set; }
		...
		/// <summary>
		///     Returns true if ApiResponseSecurityKeltnerChannel instances are equal
		/// </summary>
		/// <param name="input">Instance of ApiResponseSecurityKeltnerChannel to be compared</param>
		/// <returns>Boolean</returns>
		public bool Equals(ApiResponseSecurityKeltnerChannel input)
		{
			if (input == null)
				return false;
		...
		{
			return Equals(input as ApiResponseSecurityKeltnerChannel);
		}
