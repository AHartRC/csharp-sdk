...
namespace Intrinio.SDK.Model.ApiResponse
{
	...
	/// </summary>
	[DataContract]
	public class ApiResponseSecurityAverageTrueRange : IEquatable<ApiResponseSecurityAverageTrueRange>,
		IValidatableObject
	{
		/// <summary>
		...
		///     available..
		/// </param>
		public ApiResponseSecurityAverageTrueRange(List<AverageTrueRangeTechnicalValue> Technicals = default,
		...
		/// <summary>
		///     Returns true if ApiResponseSecurityAverageTrueRange instances are equal
		/// </summary>
		/// <param name="input">Instance of ApiResponseSecurityAverageTrueRange to be compared</param>
		/// <returns>Boolean</returns>
		public bool Equals(ApiResponseSecurityAverageTrueRange input)
		{
			if (input == null)
				return false;
		...
		public override string ToString()
		{
			...
			sb.Append("class ApiResponseSecurityAverageTrueRange {\n");
		...
		{
			return Equals(input as ApiResponseSecurityAverageTrueRange);
		}
