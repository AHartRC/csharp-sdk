...
namespace Intrinio.SDK.Model.ApiResponse
{
	...
	/// </summary>
	[DataContract]
	public class ApiResponseSecurityMassIndex : IEquatable<ApiResponseSecurityMassIndex>, IValidatableObject
	{
		/// <summary>
		///     Initializes a new instance of the <see cref="ApiResponseSecurityMassIndex" /> class.
		/// </summary>
		...
		///     available..
		/// </param>
		public ApiResponseSecurityMassIndex(List<MassIndexTechnicalValue> Technicals = default,
		...
		public List<MassIndexTechnicalValue> Technicals { get; set; }
		...
		/// <summary>
		///     Returns true if ApiResponseSecurityMassIndex instances are equal
		/// </summary>
		/// <param name="input">Instance of ApiResponseSecurityMassIndex to be compared</param>
		/// <returns>Boolean</returns>
		public bool Equals(ApiResponseSecurityMassIndex input)
		{
			if (input == null)
				return false;
		...
		{
			return Equals(input as ApiResponseSecurityMassIndex);
		}
