...
namespace Intrinio.SDK.Model.ApiResponse
{
	...
	/// </summary>
	[DataContract]
	public class ApiResponseSecurityAwesomeOscillator : IEquatable<ApiResponseSecurityAwesomeOscillator>,
		IValidatableObject
	{
		/// <summary>
		///     Initializes a new instance of the <see cref="ApiResponseSecurityAwesomeOscillator" /> class.
		/// </summary>
		...
		///     available..
		/// </param>
		public ApiResponseSecurityAwesomeOscillator(List<AwesomeOscillatorTechnicalValue> Technicals = default,
		...
		public List<AwesomeOscillatorTechnicalValue> Technicals { get; set; }
		...
		/// <summary>
		///     Returns true if ApiResponseSecurityAwesomeOscillator instances are equal
		/// </summary>
		/// <param name="input">Instance of ApiResponseSecurityAwesomeOscillator to be compared</param>
		/// <returns>Boolean</returns>
		public bool Equals(ApiResponseSecurityAwesomeOscillator input)
		{
			if (input == null)
				return false;
		...
		{
			return Equals(input as ApiResponseSecurityAwesomeOscillator);
		}
