...
namespace Intrinio.SDK.Model.ApiResponse
{
	...
	[DataContract]
	public class
		ApiResponseSecurityAverageDailyTradingVolume : IEquatable<ApiResponseSecurityAverageDailyTradingVolume>,
			IValidatableObject
	{
		/// <summary>
		...
		///     available..
		/// </param>
		public ApiResponseSecurityAverageDailyTradingVolume(
			List<AverageDailyTradingVolumeTechnicalValue> Technicals = default, TechnicalIndicator Indicator = default,
		...
		public List<AverageDailyTradingVolumeTechnicalValue> Technicals { get; set; }
		...
		/// <summary>
		///     Returns true if ApiResponseSecurityAverageDailyTradingVolume instances are equal
		/// </summary>
		/// <param name="input">Instance of ApiResponseSecurityAverageDailyTradingVolume to be compared</param>
		/// <returns>Boolean</returns>
		public bool Equals(ApiResponseSecurityAverageDailyTradingVolume input)
		{
			if (input == null)
				return false;
		...
		public override string ToString()
		{
			...
			sb.Append("class ApiResponseSecurityAverageDailyTradingVolume {\n");
		...
		{
			return Equals(input as ApiResponseSecurityAverageDailyTradingVolume);
		}
