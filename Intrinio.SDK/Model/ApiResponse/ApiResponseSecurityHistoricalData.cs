...
namespace Intrinio.SDK.Model.ApiResponse
{
	...
	/// </summary>
	[DataContract]
	public class ApiResponseSecurityHistoricalData : IEquatable<ApiResponseSecurityHistoricalData>, IValidatableObject
	{
		/// <summary>
		...
		///     available..
		/// </param>
		public ApiResponseSecurityHistoricalData(List<HistoricalData> HistoricalData = default,
