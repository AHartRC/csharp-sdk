...
namespace Intrinio.SDK.Model.ApiResponse
{
	...
	/// </summary>
	[DataContract]
	public class ApiResponseSecurityVortexIndicator : IEquatable<ApiResponseSecurityVortexIndicator>, IValidatableObject
	{
		/// <summary>
		///     Initializes a new instance of the <see cref="ApiResponseSecurityVortexIndicator" /> class.
		/// </summary>
		...
		///     available..
		/// </param>
		public ApiResponseSecurityVortexIndicator(List<VortexIndicatorTechnicalValue> Technicals = default,
		...
		public List<VortexIndicatorTechnicalValue> Technicals { get; set; }
		...
		/// <summary>
		///     Returns true if ApiResponseSecurityVortexIndicator instances are equal
		/// </summary>
		/// <param name="input">Instance of ApiResponseSecurityVortexIndicator to be compared</param>
		/// <returns>Boolean</returns>
		public bool Equals(ApiResponseSecurityVortexIndicator input)
		{
			if (input == null)
				return false;
		...
		public override string ToString()
		{
			...
			sb.Append("class ApiResponseSecurityVortexIndicator {\n");
		...
		{
			return Equals(input as ApiResponseSecurityVortexIndicator);
		}
