...
namespace Intrinio.SDK.Model.ApiResponse
{
	...
	/// </summary>
	[DataContract]
	public class ApiResponseSecurityWilliamsR : IEquatable<ApiResponseSecurityWilliamsR>, IValidatableObject
	{
		/// <summary>
		...
		///     available..
		/// </param>
		public ApiResponseSecurityWilliamsR(List<WilliamsRTechnicalValue> Technicals = default,
		...
		public List<WilliamsRTechnicalValue> Technicals { get; set; }
		...
		/// <summary>
		///     Returns true if ApiResponseSecurityWilliamsR instances are equal
		/// </summary>
		/// <param name="input">Instance of ApiResponseSecurityWilliamsR to be compared</param>
		/// <returns>Boolean</returns>
		public bool Equals(ApiResponseSecurityWilliamsR input)
		{
			if (input == null)
				return false;
		...
		public override string ToString()
		{
			...
			sb.Append("class ApiResponseSecurityWilliamsR {\n");
		...
		{
			return Equals(input as ApiResponseSecurityWilliamsR);
		}
