...
namespace Intrinio.SDK.Model.ApiResponse
{
	...
	/// </summary>
	[DataContract]
	public class ApiResponseSecurityMoneyFlowIndex : IEquatable<ApiResponseSecurityMoneyFlowIndex>, IValidatableObject
	{
		/// <summary>
		///     Initializes a new instance of the <see cref="ApiResponseSecurityMoneyFlowIndex" /> class.
		/// </summary>
		...
		///     available..
		/// </param>
		public ApiResponseSecurityMoneyFlowIndex(List<MoneyFlowIndexTechnicalValue> Technicals = default,
		...
		public List<MoneyFlowIndexTechnicalValue> Technicals { get; set; }
		...
		/// <summary>
		///     Returns true if ApiResponseSecurityMoneyFlowIndex instances are equal
		/// </summary>
		/// <param name="input">Instance of ApiResponseSecurityMoneyFlowIndex to be compared</param>
		/// <returns>Boolean</returns>
		public bool Equals(ApiResponseSecurityMoneyFlowIndex input)
		{
			if (input == null)
				return false;
		...
		public override string ToString()
		{
			...
			sb.Append("class ApiResponseSecurityMoneyFlowIndex {\n");
		...
		{
			return Equals(input as ApiResponseSecurityMoneyFlowIndex);
		}
