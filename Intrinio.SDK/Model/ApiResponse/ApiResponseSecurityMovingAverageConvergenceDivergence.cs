...
namespace Intrinio.SDK.Model.ApiResponse
{
	...
	public class
		ApiResponseSecurityMovingAverageConvergenceDivergence :
			IEquatable<ApiResponseSecurityMovingAverageConvergenceDivergence>, IValidatableObject
	{
		/// <summary>
		...
		///     available..
		/// </param>
		public ApiResponseSecurityMovingAverageConvergenceDivergence(
			List<MovingAverageConvergenceDivergenceTechnicalValue> Technicals = default,
		...
		public List<MovingAverageConvergenceDivergenceTechnicalValue> Technicals { get; set; }
		...
		/// <summary>
		///     Returns true if ApiResponseSecurityMovingAverageConvergenceDivergence instances are equal
		/// </summary>
		/// <param name="input">Instance of ApiResponseSecurityMovingAverageConvergenceDivergence to be compared</param>
		/// <returns>Boolean</returns>
		public bool Equals(ApiResponseSecurityMovingAverageConvergenceDivergence input)
		{
			if (input == null)
				return false;
		...
		{
			return Equals(input as ApiResponseSecurityMovingAverageConvergenceDivergence);
		}
