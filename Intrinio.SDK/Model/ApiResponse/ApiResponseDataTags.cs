...
namespace Intrinio.SDK.Model.ApiResponse
{
	...
	/// </summary>
	[DataContract]
	public class ApiResponseDataTags : IEquatable<ApiResponseDataTags>, IValidatableObject
	{
		/// <summary>
		...
		///     available..
		/// </param>
		public ApiResponseDataTags(List<DataTag> Tags = default, string NextPage = default)
		{
			this.Tags = Tags;
		...
		{
			return Equals(input as ApiResponseDataTags);
		}
