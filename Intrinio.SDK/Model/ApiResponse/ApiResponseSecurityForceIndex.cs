...
namespace Intrinio.SDK.Model.ApiResponse
{
	...
	/// </summary>
	[DataContract]
	public class ApiResponseSecurityForceIndex : IEquatable<ApiResponseSecurityForceIndex>, IValidatableObject
	{
		/// <summary>
		...
		///     available..
		/// </param>
		public ApiResponseSecurityForceIndex(List<ForceIndexTechnicalValue> Technicals = default,
