...
namespace Intrinio.SDK.Model.ApiResponse
{
	...
	/// </summary>
	[DataContract]
	public class ApiResponseSecurityOnBalanceVolume : IEquatable<ApiResponseSecurityOnBalanceVolume>, IValidatableObject
	{
		/// <summary>
		///     Initializes a new instance of the <see cref="ApiResponseSecurityOnBalanceVolume" /> class.
		/// </summary>
		...
		///     available..
		/// </param>
		public ApiResponseSecurityOnBalanceVolume(List<OnBalanceVolumeTechnicalValue> Technicals = default,
		...
		public List<OnBalanceVolumeTechnicalValue> Technicals { get; set; }
		...
		/// <summary>
		///     Returns true if ApiResponseSecurityOnBalanceVolume instances are equal
		/// </summary>
		/// <param name="input">Instance of ApiResponseSecurityOnBalanceVolume to be compared</param>
		/// <returns>Boolean</returns>
		public bool Equals(ApiResponseSecurityOnBalanceVolume input)
		{
			if (input == null)
				return false;
		...
		public override string ToString()
		{
			...
			sb.Append("class ApiResponseSecurityOnBalanceVolume {\n");
		...
		{
			return Equals(input as ApiResponseSecurityOnBalanceVolume);
		}
