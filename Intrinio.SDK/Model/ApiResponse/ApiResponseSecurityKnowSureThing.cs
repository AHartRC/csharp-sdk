...
namespace Intrinio.SDK.Model.ApiResponse
{
	...
	/// </summary>
	[DataContract]
	public class ApiResponseSecurityKnowSureThing : IEquatable<ApiResponseSecurityKnowSureThing>, IValidatableObject
	{
		/// <summary>
		...
		///     available..
		/// </param>
		public ApiResponseSecurityKnowSureThing(List<KnowSureThingTechnicalValue> Technicals = default,
		...
		public List<KnowSureThingTechnicalValue> Technicals { get; set; }
		...
		/// <summary>
		///     Returns true if ApiResponseSecurityKnowSureThing instances are equal
		/// </summary>
		/// <param name="input">Instance of ApiResponseSecurityKnowSureThing to be compared</param>
		/// <returns>Boolean</returns>
		public bool Equals(ApiResponseSecurityKnowSureThing input)
		{
			if (input == null)
				return false;
		...
		{
			return Equals(input as ApiResponseSecurityKnowSureThing);
		}
