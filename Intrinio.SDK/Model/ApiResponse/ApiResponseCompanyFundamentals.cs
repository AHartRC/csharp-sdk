...
namespace Intrinio.SDK.Model.ApiResponse
{
	...
	/// </summary>
	[DataContract]
	public class ApiResponseCompanyFundamentals : IEquatable<ApiResponseCompanyFundamentals>, IValidatableObject
	{
		/// <summary>
		...
		///     available..
		/// </param>
		public ApiResponseCompanyFundamentals(List<FundamentalSummary> Fundamentals = default,
