...
namespace Intrinio.SDK.Model.ApiResponse
{
	...
	/// </summary>
	[DataContract]
	public class ApiResponseSecurityBollingerBands : IEquatable<ApiResponseSecurityBollingerBands>, IValidatableObject
	{
		/// <summary>
		...
		///     available..
		/// </param>
		public ApiResponseSecurityBollingerBands(List<BollingerBandsTechnicalValue> Technicals = default,
		...
		public List<BollingerBandsTechnicalValue> Technicals { get; set; }
		...
		/// <summary>
		///     Returns true if ApiResponseSecurityBollingerBands instances are equal
		/// </summary>
		/// <param name="input">Instance of ApiResponseSecurityBollingerBands to be compared</param>
		/// <returns>Boolean</returns>
		public bool Equals(ApiResponseSecurityBollingerBands input)
		{
			if (input == null)
				return false;
		...
		public override string ToString()
		{
			...
			sb.Append("class ApiResponseSecurityBollingerBands {\n");
		...
		{
			return Equals(input as ApiResponseSecurityBollingerBands);
		}
