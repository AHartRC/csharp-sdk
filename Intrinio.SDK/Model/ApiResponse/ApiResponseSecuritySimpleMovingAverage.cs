...
namespace Intrinio.SDK.Model.ApiResponse
{
	...
	/// </summary>
	[DataContract]
	public class ApiResponseSecuritySimpleMovingAverage : IEquatable<ApiResponseSecuritySimpleMovingAverage>,
		IValidatableObject
	{
		/// <summary>
		///     Initializes a new instance of the <see cref="ApiResponseSecuritySimpleMovingAverage" /> class.
		/// </summary>
		...
		///     available..
		/// </param>
		public ApiResponseSecuritySimpleMovingAverage(List<SimpleMovingAverageTechnicalValue> Technicals = default,
		...
		public List<SimpleMovingAverageTechnicalValue> Technicals { get; set; }
		...
		/// <summary>
		///     Returns true if ApiResponseSecuritySimpleMovingAverage instances are equal
		/// </summary>
		/// <param name="input">Instance of ApiResponseSecuritySimpleMovingAverage to be compared</param>
		/// <returns>Boolean</returns>
		public bool Equals(ApiResponseSecuritySimpleMovingAverage input)
		{
			if (input == null)
				return false;
		...
		{
			return Equals(input as ApiResponseSecuritySimpleMovingAverage);
		}
