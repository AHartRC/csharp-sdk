...
namespace Intrinio.SDK.Model.ApiResponse
{
	...
	/// </summary>
	[DataContract]
	public class ApiResponseSecurityCommodityChannelIndex : IEquatable<ApiResponseSecurityCommodityChannelIndex>,
		IValidatableObject
	{
		/// <summary>
		...
		///     available..
		/// </param>
		public ApiResponseSecurityCommodityChannelIndex(List<CommodityChannelIndexTechnicalValue> Technicals = default,
		...
		{
			return Equals(input as ApiResponseSecurityCommodityChannelIndex);
		}
