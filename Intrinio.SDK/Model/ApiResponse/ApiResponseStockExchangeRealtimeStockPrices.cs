...
namespace Intrinio.SDK.Model.ApiResponse
{
	...
	/// </summary>
	[DataContract]
	public class ApiResponseStockExchangeRealtimeStockPrices : IEquatable<ApiResponseStockExchangeRealtimeStockPrices>,
		IValidatableObject
	{
		/// <summary>
		...
		///     available..
		/// </param>
		public ApiResponseStockExchangeRealtimeStockPrices(List<RealtimeStockPrice> StockPrices = default,
