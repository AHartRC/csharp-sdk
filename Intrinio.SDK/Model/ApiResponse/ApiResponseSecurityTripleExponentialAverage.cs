...
namespace Intrinio.SDK.Model.ApiResponse
{
	...
	/// </summary>
	[DataContract]
	public class ApiResponseSecurityTripleExponentialAverage : IEquatable<ApiResponseSecurityTripleExponentialAverage>,
		IValidatableObject
	{
		/// <summary>
		...
		///     available..
		/// </param>
		public ApiResponseSecurityTripleExponentialAverage(
			List<TripleExponentialAverageTechnicalValue> Technicals = default, TechnicalIndicator Indicator = default,
		...
		{
			return Equals(input as ApiResponseSecurityTripleExponentialAverage);
		}
