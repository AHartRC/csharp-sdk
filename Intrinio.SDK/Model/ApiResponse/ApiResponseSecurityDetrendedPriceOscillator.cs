...
namespace Intrinio.SDK.Model.ApiResponse
{
	...
	/// </summary>
	[DataContract]
	public class ApiResponseSecurityDetrendedPriceOscillator : IEquatable<ApiResponseSecurityDetrendedPriceOscillator>,
		IValidatableObject
	{
		/// <summary>
		...
		///     available..
		/// </param>
		public ApiResponseSecurityDetrendedPriceOscillator(
			List<DetrendedPriceOscillatorTechnicalValue> Technicals = default, TechnicalIndicator Indicator = default,
		...
		public List<DetrendedPriceOscillatorTechnicalValue> Technicals { get; set; }
		...
		/// <summary>
		///     Returns true if ApiResponseSecurityDetrendedPriceOscillator instances are equal
		/// </summary>
		/// <param name="input">Instance of ApiResponseSecurityDetrendedPriceOscillator to be compared</param>
		/// <returns>Boolean</returns>
		public bool Equals(ApiResponseSecurityDetrendedPriceOscillator input)
		{
			if (input == null)
				return false;
		...
		public override string ToString()
		{
			...
			sb.Append("class ApiResponseSecurityDetrendedPriceOscillator {\n");
		...
		{
			return Equals(input as ApiResponseSecurityDetrendedPriceOscillator);
		}
