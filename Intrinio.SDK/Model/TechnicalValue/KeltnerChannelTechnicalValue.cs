...
namespace Intrinio.SDK.Model.TechnicalValue
{
	...
	/// </summary>
	[DataContract]
	public class KeltnerChannelTechnicalValue : IEquatable<KeltnerChannelTechnicalValue>, IValidatableObject
	{
		/// <summary>
		...
		public KeltnerChannelTechnicalValue(DateTime? DateTime = default, float? LowerBand = default,
			float? MiddleBand = default, float? UpperBand = default)
		{
		...
		{
			return Equals(input as KeltnerChannelTechnicalValue);
		}
