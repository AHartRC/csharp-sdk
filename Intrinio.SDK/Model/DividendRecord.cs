...
namespace Intrinio.SDK.Model
{
	...
	/// </summary>
	[DataContract]
	public class DividendRecord : IEquatable<DividendRecord>, IValidatableObject
	{
		/// <summary>
		...
		/// <param name="LastExDividendDate">
		///     The last reported day the stock starts trading without the value of its next dividend
		///     payment.
		/// </param>
		/// <param name="Security">Security.</param>
		public DividendRecord(decimal? ExDividend = default, string Currency = default,
			DateTime? AnnouncementDate = default, DateTime? RecordDate = default, DateTime? PayDate = default,
			string Frequency = default, DividendStatusEnum? Status = default, decimal? ForwardYield = default,
			decimal? ForwardRate = default, DateTime? LastExDividendDate = default, SecuritySummary Security = default)
		{
		...
		public DividendStatusEnum? Status { get; set; }
