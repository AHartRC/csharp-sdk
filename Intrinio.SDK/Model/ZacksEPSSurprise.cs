...
namespace Intrinio.SDK.Model
{
	...
	///     by the company, providing the amount and percent surprise on release. Each EPS Surprise includes metadata about the
	///     corresponding Security.
	/// </summary>
	[DataContract]
	public class ZacksEPSSurprise : IEquatable<ZacksEPSSurprise>, IValidatableObject
	{
		/// <summary>
		...
		public ZacksEPSSurprise(string Id = default, decimal? FiscalYear = default, string FiscalQuarter = default,
			...
			string ActualReportedDesc = default, decimal? EpsActual = default, decimal? EpsActualZacksAdj = default,
			decimal? EpsMeanEstimate = default, decimal? EpsAmountDiff = default, decimal? EpsPercentDiff = default,
			decimal? EpsCountEstimate = default, decimal? EpsStdDevEstimate = default,
