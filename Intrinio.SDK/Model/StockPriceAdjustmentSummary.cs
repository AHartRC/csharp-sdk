...
namespace Intrinio.SDK.Model
{
	...
	/// </summary>
	[DataContract]
	public class StockPriceAdjustmentSummary : IEquatable<StockPriceAdjustmentSummary>, IValidatableObject
	{
		/// <summary>
		...
		public StockPriceAdjustmentSummary(DateTime? Date = default, decimal? Factor = default,
			decimal? Dividend = default, string DividendCurrency = default, decimal? SplitRatio = default)
		{
			this.Date = Date;
			this.Factor = Factor;
