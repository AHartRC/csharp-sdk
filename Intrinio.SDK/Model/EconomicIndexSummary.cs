...
namespace Intrinio.SDK.Model
{
	...
	/// </summary>
	[DataContract]
	public class EconomicIndexSummary : IEquatable<EconomicIndexSummary>, IValidatableObject
	{
		/// <summary>
		...
		public EconomicIndexSummary(string Id = default, string Symbol = default, string Name = default,
			string Continent = default, string Country = default, string UpdateFrequency = default,
			DateTime? LastUpdated = default, DateTime? ObservationStart = default, DateTime? ObservationEnd = default,
			string SeasonalAdjustment = default, string Units = default)
		{
			this.Id = Id;
			this.Symbol = Symbol;
			this.Name = Name;
