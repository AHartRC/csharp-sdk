...
namespace Intrinio.SDK.Model
{
	...
	/// </summary>
	[DataContract]
	public class Filing : IEquatable<Filing>, IValidatableObject
	{
		/// <summary>
		...
		public Filing(string Id = default, DateTime? FilingDate = default, DateTime? AcceptedDate = default,
			...
			string IndustryCategory = default, string IndustryGroup = default, int? WordCount = default,
