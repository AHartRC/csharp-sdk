...
namespace Intrinio.SDK.Model
{
	...
	/// </summary>
	[DataContract]
	public class StockPriceAdjustment : IEquatable<StockPriceAdjustment>, IValidatableObject
	{
		/// <summary>
		///     Initializes a new instance of the <see cref="StockPriceAdjustment" /> class.
		/// </summary>
		/// <param name="Date">
		///     The date on which the adjustment occurred. The adjustment should be applied to all stock prices
		///     before this date..
		/// </param>
		/// <param name="Factor">
		///     The factor by which to multiply stock prices before this date, in order to calculate
		///     historically-adjusted stock prices..
		/// </param>
		...
		public StockPriceAdjustment(DateTime? Date = default, decimal? Factor = default, decimal? Dividend = default,
			string DividendCurrency = default, decimal? SplitRatio = default, SecuritySummary Security = default)
		{
			this.Date = Date;
			this.Factor = Factor;
		...
		/// </summary>
		/// <value>
		///     The date on which the adjustment occurred. The adjustment should be applied to all stock prices before this
		///     date.
		/// </value>
		...
		/// <summary>
		///     The factor by which to multiply stock prices before this date, in order to calculate historically-adjusted stock
		///     prices.
		/// </summary>
		/// <value>
		///     The factor by which to multiply stock prices before this date, in order to calculate historically-adjusted stock
