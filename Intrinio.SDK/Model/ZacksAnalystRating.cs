...
namespace Intrinio.SDK.Model
{
	...
	///     includes data about mean, strong buys, buys, holds, sells, strong sells, and total. Each rating includes metadata
	///     about the corresponding Security.
	/// </summary>
	[DataContract]
	public class ZacksAnalystRating : IEquatable<ZacksAnalystRating>, IValidatableObject
	{
		/// <summary>
		...
		public ZacksAnalystRating(string Id = default, DateTime? Date = default, decimal? Mean = default,
			int? StrongBuys = default, int? Buys = default, int? Holds = default, int? Sells = default,
			int? StrongSells = default, int? Total = default, SecuritySummary Security = default)
		{
			this.Id = Id;
			this.Date = Date;
			this.Mean = Mean;
