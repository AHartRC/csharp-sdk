...
namespace Intrinio.SDK.Client
{
	...
	public class Configuration : IReadableConfiguration
	{
		...
		public static readonly ExceptionFactory DefaultExceptionFactory = (methodName, response) =>
		{
			...
			if (status == 0)
				return new ApiException(status,
					$"Error calling {methodName}: {response.ReasonPhrase}", response.ReasonPhrase);
			return null;
		};
		...
		{
			UserAgent = "Swagger-Codegen/5.7.0/csharp";
		...
		public Configuration(
			...
			string userAgent = "Swagger-Codegen/5.7.0/csharp"
		...
		{
			var report = "C# SDK (Intrinio.SDK) Debug Report:\n";
			report += "    OS: " + Environment.OSVersion + "\n";
			report += "    .NET Framework Version: " + Environment.Version + "\n";
			report += "    Version of the API: 2.17.0\n";
			report += "    SDK Package Version: 5.7.0\n";
